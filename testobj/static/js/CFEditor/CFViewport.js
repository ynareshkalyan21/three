...
(function (v) {
    ...
    v.Viewport = function (editor) {
        ...
        var camera = editor.camera, config = editor.config.configData;
        ...
        controls.center.fromArray(config.cameraTarget);
        ...
        signals.editorInit.add(function () {
        ...
        signals.cameraChanged.add(function () {
            ...
            saveTimeout = setTimeout(function () {
                ...
                editor.config.setConfig('cameraPosition', camera.position.toArray());
                editor.config.setConfig('cameraTarget', camera.position.toArray());
...
})(window.CFViewport = window.CFViewport || {});