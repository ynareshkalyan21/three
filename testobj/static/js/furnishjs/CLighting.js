...
(function (cl) {
    ...
    cl.light = function (type, color, distance, intensity, position, rotation, height, width, hastarget) {
    ...
    cl.light.prototype.setLight = function () {
        ...
        lightCode = cl.getLightCode(this.type);
        ...
        switch (lightCode) {
            ...
            case 5:
                ...
                if (this.target) {
                    ...
                    csScene.scene.add(obj);
                    spotLight.target = obj;
                }
                csScene.scene.add(spotLight);
                break;

            default:

                var defambient = new THREE.AmbientLight(this.color);
                csScene.add(defambient);
                break;
